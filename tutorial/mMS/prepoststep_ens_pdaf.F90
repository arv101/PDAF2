...
! **************************************************************
  ...
  !     OPEN(11, file='outputs/ens_mean_size_'//TRIM(ens_size_str)//'_Obs_' &
...
! ********************
  ...
  ! OPEN(11, file = 'results/rmse_ens_size_'//TRIM(ens_size_str)//'_obs_'// &
  ...
  ! OPEN(11, file = 'results/spread_ens_size_'//TRIM(ens_size_str)// &
